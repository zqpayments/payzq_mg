...
class Curl extends AbstractHelper {
    ...
    public function request($method, $absUrl, $headers, $params, $hasFile)
    {
        ...
        if (is_callable($this->defaultOptions)) { // call defaultOptions callback, set options to return value
            ...
            if (!is_array($opts)) {
                throw new Exception("Non-array value returned by defaultOptions CurlClient callback");
            }
    ...
    private function handleCurlError($url, $errno, $message)
    {
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to PayZQ ($url).  Please check your "
                 . "internet connection and try again.  If this problem persists, ";
                break;
            case CURLE_SSL_CACERT:
            case CURLE_SSL_PEER_CERTIFICATE:
                $msg = "Could not verify PayZQ's SSL certificate.  Please make sure "
                 . "that your network is not intercepting certificates.  "
                 . "(Try going to $url in your browser.)  "
                 . "If this problem persists,";
                break;
            default:
                $msg = "Unexpected error communicating with PayZQ.  "
                 . "If this problem persists,";
        }
        $msg .= " let us know at support@payzq.com.";
        ...
        if (self::$isMbstringAvailable === null) {
            ...
            if (!self::$isMbstringAvailable) {
                trigger_error("It looks like the mbstring extension is not enabled. " .
                    ...
                    "support@payzq.com if you have any questions.", E_USER_WARNING);
            }
        }
